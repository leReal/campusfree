...
$this->menu=array(
	...
	array('label'=>'Modifier la filière', 'url'=>array('update', 'id'=>$model->id)),
	array('label'=>'Supprimer la filière', 'url'=>'#', 'linkOptions'=>array('submit'=>array('delete','id'=>$model->id),'confirm'=>'Are you sure you want to delete this item?')),
