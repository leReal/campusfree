...
--
-- Client: 127.0.0.1
-- Généré le: Jeu 05 Décembre 2013 à 11:11
...
--
-- Structure de la table `informateur_classe`
--

CREATE TABLE IF NOT EXISTS `informateur_classe` (
...
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Table qui regroupe les classes associées aux informateurs' AUTO_INCREMENT=1 ;
...
INSERT INTO `tbl_information` (`id`, `titresms`, `contenusms`, `titremail`, `contenumail`, `id_informateur`, `etablissement_id`) VALUES
(10, '', '', 'TEST DE CONFIRMATION', 'test', 3, NULL);
...
CREATE TABLE IF NOT EXISTS `tbl_institution` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='table sui regroupe les différentes institutions' AUTO_INCREMENT=3 ;
...
(2, 'Université de Douala 2', 'Douala', '13248965', '44542323', '', '535', 'Douala', 'public');
...
--
-- Contraintes pour la table `informateur_classe`
--
ALTER TABLE `informateur_classe`
  ADD CONSTRAINT `informateur_classe_ibfk_1` FOREIGN KEY (`id_classe`) REFERENCES `tbl_classe` (`id`),
  ADD CONSTRAINT `informateur_classe_ibfk_2` FOREIGN KEY (`id_utilisateur`) REFERENCES `tbl_utilisateur` (`id`);
